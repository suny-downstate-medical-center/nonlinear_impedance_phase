...
axs[0].plot(base['f_minus'], base['phi_minus'], 'k-', label='Baseline')
axs[0].plot(base['f_plus'], base['phi_plus'], 'k--')
axs[0].plot(blockKA['f_minus'], blockKA['phi_minus'], 'r-', label=r'Block I$_A$')
axs[0].plot(blockKA['f_plus'], blockKA['phi_plus'], 'r--')
axs[1].plot(apic['f_minus'], apic['phi_minus'], 'k-', label='Baseline')
axs[1].plot(apic['f_plus'], apic['phi_plus'], 'k--')
...
axs[1].set_title('Apical', fontsize=18)