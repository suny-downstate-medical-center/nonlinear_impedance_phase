...
axs[0][0].plot([i for i in range(len(retreat['lags']))], [radians(val)*-1 for val in retreat['angles']], 'o-', color='black', label='Baseline')
...
axs[0][1].plot([i for i in range(len(retreatApic['lags']))], [radians(val)*-1 for val in retreatApic['angles']], 'o-', color='black', label='Baseline')
...
axs[1][0].plot([i for i in range(len(retreat['lags']))], [radians(val)*-1 for val in retreat['angles']], 'o-', color='black', label='Baseline')
...
axs[1][1].plot([i for i in range(len(retreatApic['lags']))], [radians(val)*-1 for val in retreatApic['angles']], 'o-', color='black', label='Baseline')
...
axs[2][0].plot([i for i in range(len(retreat['lags']))], [radians(val)*-1 for val in retreat['angles']], 'o-', color='black', label='Baseline')
...
axs[2][1].plot([i for i in range(len(retreatApic['lags']))], [radians(val)*-1 for val in retreatApic['angles']], 'o-', color='black', label='Baseline')
...
axs[3][0].plot([i for i in range(len(retreat['lags']))], [radians(val)*-1 for val in retreat['angles']], 'o-', color='black', label='Baseline')
...
axs[3][1].plot([i for i in range(len(retreatApic['lags']))], [radians(val)*-1 for val in retreatApic['angles']], 'o-', color='black', label='Baseline')
...
axs[0][2].plot([i for i in range(len(advance['lags']))], [radians(val)*-1 for val in advance['angles']], 'o-', color='black', label='Baseline')
...
axs[0][3].plot([i for i in range(len(advanceApic['lags']))], [radians(val)*-1 for val in advanceApic['angles']], 'o-', color='black', label='Baseline')
...
axs[1][2].plot([i for i in range(len(advance['lags']))], [radians(val)*-1 for val in advance['angles']], 'o-', color='black', label='Baseline')
axs[1][2].plot([i for i in range(len(advanceIm['lags']))], [radians(val)*-1 for val in advanceIm['angles']], 'o-', color='red', label='Baseline')
# axs[1][0].set_xlim(-0.1, 10)

axs[1][3].plot([i for i in range(len(advanceApic['lags']))], [radians(val)*-1 for val in advanceApic['angles']], 'o-', color='black', label='Baseline')
...
axs[2][2].plot([i for i in range(len(advance['lags']))], [radians(val)*-1 for val in advance['angles']], 'o-', color='black', label='Baseline')
axs[2][2].plot([i for i in range(len(advanceLVA['lags']))], [radians(val)*-1 for val in advanceLVA['angles']], 'o-', color='red', label='Baseline')
# axs[2][0].set_xlim(-0.1, 10)

axs[2][3].plot([i for i in range(len(advanceApic['lags']))], [radians(val)*-1 for val in advanceApic['angles']], 'o-', color='black', label='Baseline')
...
axs[3][2].plot([i for i in range(len(advance['lags']))], [radians(val)*-1 for val in advance['angles']], 'o-', color='black', label='Baseline')
...
axs[3][3].plot([i for i in range(len(advanceApic['lags']))], [radians(val)*-1 for val in advanceApic['angles']], 'o-', color='black', label='Baseline')
