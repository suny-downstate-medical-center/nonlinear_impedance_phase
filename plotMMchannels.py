...
# plt.plot(blockIhKm['f_minus'], blockIhKm['phi_minus'], '-', label=r'Block I$_h$ & I$_m$', color='gray')
# plt.plot(blockIhKm['f_plus'], blockIhKm['phi_plus'], '--', color='gray')
# plt.plot(blockIhKm['f_minus'], blockIhKm['phi_minus'], '-', label=r'Block I$_h$, I$_m$, & I$_A$', color='green')
# plt.plot(blockIhKm['f_plus'], blockIhKm['phi_plus'], '--', color='green')
