...
** TODO: finish plot showing traces and impedance phase for linear sub, nonlinear sub, supra w/ TTX, and supra 
** TODO: convert other figures from phase via hilbert to new method 
** TODO: rewrite text accordingly 