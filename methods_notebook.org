...
** outline for figures 
*** 1, 2, unchanged 
*** TODO - new 3 - compare three models with morphs and phase shifts at baseline
*** 3->4  
*** current 4 might get consolidated 
*** TODO - new 5 - ca1 model and multiple resonances 
*** 5->7, TODO - replace amplitude with other models 
*** 6->8, maybe TODO - include comparison for ca1 cell 
*** 7->9, TODO - replace amplitude with other models 
