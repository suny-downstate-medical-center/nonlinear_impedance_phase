...
axs[0][0].plot(base['f_minus'], base['phi_minus'], 'b-', label='Baseline')
...
axs[1][1].plot(distal['f_minus'], distal['phi_minus'], 'b-', label='Baseline')
axs[1][1].plot(distal['f_plus'], distal['phi_plus'], 'b--')
axs[1][0].set_xlim(0.5,10)
axs[1][1].set_xlim(0.5,10)
axs[1][0].legend(title='Condition')

axs[2][0].plot(base['f_minus'], base['phi_minus'], 'b-', label='Baseline')
...
axs[2][1].plot(distal['f_minus'], distal['phi_minus'], 'b-', label='Baseline')
axs[2][1].plot(distal['f_plus'], distal['phi_plus'], 'b--')
axs[2][0].set_xlim(0.5,10)
axs[2][1].set_xlim(0.5,10)
axs[2][0].legend(title='Condition')

axs[3][0].plot(baseTASK['f_minus'], baseTASK['phi_minus'], 'b-', label='Baseline')
axs[3][0].plot(baseTASK['f_plus'], baseTASK['phi_plus'], 'b--')
axs[3][0].plot(blockTASK['f_minus'], blockTASK['phi_minus'], 'r-', label=r'Block TASK-like shunting current')
axs[3][0].plot(blockTASK['f_plus'], blockTASK['phi_plus'], 'r--')
axs[3][1].plot(blockTASKApic['f_minus'], blockTASKApic['phi_minus'], 'r-', label=r'Block TASK-like shunting current')
axs[3][1].plot(blockTASKApic['f_plus'], blockTASKApic['phi_plus'], 'r--')
axs[3][1].plot(apic['f_minus'], apic['phi_minus'], 'b-', label='Baseline')
axs[3][1].plot(apic['f_plus'], apic['phi_plus'], 'b--')
axs[3][0].set_xlim(0.5,10)
axs[3][1].set_xlim(0.5,10)
axs[3][0].legend(title='Condition')
